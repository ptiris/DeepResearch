...
3. **JSON requirements**:
   ...
   - The "arguments" value MUST be a JSON object (not a string, not an array, not key-value pairs without braces)
   - Correct: {"name": "search", "arguments": {"query": ["q1", "q2"]}}
   - Wrong: {"name": "search", "arguments": "query": ["q1", "q2"]}
